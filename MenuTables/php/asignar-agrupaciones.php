...
<br>
      <div>
        ...
        <form action="" method="POST">
            ...
            <label for="">Ingresa el id de la agrupaciones</label>
            <input type="text" name="id"><br>
            <label for="">Indica si le vas a asignar un Rubro o Subrubro</label>
            <select name="r/c" >
                    <option>Rubro</option>
                    <option>Subrubro</option>
            </select><br>
            <label for="">Ingresa el codigo de ese rubro o subrubro</label>
            <input type="selection" name="codigo"><br>
...
<?php
  ...
  if(isset($_POST['enviar'])){
    ...
    $insertarDatos = "INSERT INTO agrupaciones VALUES('', '$id', '$r_c', '$codigo')";
